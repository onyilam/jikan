...
from .views import searchpaper, get_recommendation, HomePageView, like_paper, paper_detail, add_comment_to_paper, add_paper, JournalAutocomplete#, PaperCreateView
