...
from .views import searchpaper, get_recommendation, edit_paper, HomePageView, like_paper, paper_detail, add_paper, autocompletePaper#, PaperCreateView
...
urlpatterns = [
     ...
     url(r'/edit/<int:pk>/', edit_paper, name='edit_paper'),
     #url(r'^edit/(?P<pk>\d+)/$', edit_paper, name = "edit_paper"),
